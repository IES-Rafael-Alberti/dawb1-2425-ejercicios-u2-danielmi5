...
# pide la frase y la retorna
def pedir_frase():
    frase = input("Introduzca una frase: ").strip() # elimino los espacios antes y despues de la frase
    return frase
#compruebo si letra es una letra, si no bucle hasta que sí. Al final retorna letra
def comprobar_letra(letra: str) -> str:
    letra = letra.lower() # La transformo en minúsculas
