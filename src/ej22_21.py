...
# comprueba si el monto es negativo (si lo es bucle, para pedir otro valor) y si es 0 (retorna None, para después en el while del main)
def comprobar_monto(num):
    ...
    return num
#pide el monto y lo retorna comprobado
def ingreso_monto():
